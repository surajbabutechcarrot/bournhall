...
export function HomeCta() {
  return (
    <section className="surface-cta home-cta-pad relative overflow-hidden section-y pb-28 text-center sm:pb-36 lg:min-h-[min(560px,78dvh)] lg:pb-44">
      <Container size="narrow" className="relative z-10">
        <p className="text-xs font-semibold tracking-[0.25em] text-[#b1487e] uppercase sm:text-sm">
          Your next step
        </p>

        <h2 className="mt-3.5 text-4xl leading-[1.12] font-medium tracking-tight text-ink-950 sm:text-5xl lg:text-[56px]">
          Ready to Take the{" "}
          <span className="text-brand-500">Next Step?</span>
        </h2>
